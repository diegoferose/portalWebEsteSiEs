            ...
            <div class="row">
                <div class="contenedor">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tbody>
                                <tr>
                                    <td><img src="../web/img/carrusel1.png" height="150" width="150" class="img-responsive"></td>
                                    <td><a style="margin-left: 15px;">Evento 1 descripcion:ljdlasjdksjdjsakdjsadsjsdksdklsakldskld</a></td>
                                </tr>
                                <tr>
                                    <td><img src="../web/img/carrusel1.png" height="150" width="150" class="img-responsive"></td>
                                    <td><a style="margin-left: 15px;">Evento 1 descripcion:ljdlasjdksjdjsakdjsadsjsdksdklsakldskld</a></td>
