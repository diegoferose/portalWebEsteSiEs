                        ...
                        <div class="contenedorCentro">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="../web/img/images.jpg" alt="..." width="400" height="400">
                                    <div class="carousel-caption">
                                        ...
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="../web/img/Fondox.net_diseno-digital-de-libros_1920x1200.jpg" alt="..." width="400" height="400">
                                    <div class="carousel-caption">
                                        ...
                                    </div>
                                </div>
                            ...
                            <br>
                            <center>
                                <strong>Nombre: </strong> Mi evento <br>
                                <strong>Fecha: </strong> 12/11/2015 <br>
                                <strong>Lugar: </strong> Vertiguito <br>
                                <strong>Descripcion: </strong> Este es un evento <br>
                            ...
                            <br>
                            <label style="vertical-align: top;">AGREGAR UN COMENTARIO</label>
