        ...
        <div class="container container-fluid">
            ...
            <div class="row">
                <div class="contenedor">
                    ...
                    <center><h1>¿QUE HAY PARA HACER?</h1></center>
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img src="../web/img/images.jpg" class="img-responsive" alt="...">
                                <div class="carousel-caption">
                                    ...
                                </div>
                            </div>
                            <div class="item">
                                <img src="../web/img/Fondox.net_diseno-digital-de-libros_1920x1200.jpg" class="img-responsive" alt="...">
                                <div class="carousel-caption">
                                    ...
                                </div>
                            </div>
                            <div class="item">
                                <img src="../web/img/Basílica_de_Buga.jpg" class="img-responsive" alt="...">
                                <div class="carousel-caption">
                                    ...
                                </div>
                            </div>
                            <h4>Eventos recientes en la ciudad de buga</h4>
                        </div>
