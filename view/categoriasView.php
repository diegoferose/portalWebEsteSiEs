            ...
            <div class="row">
                <div class="contenedor">
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-12 text-center"> <img class="img-circle" alt="140x140" style="width: 140px; height: 140px;" src="../web/img/140X140.gif" data-holder-rendered="true">
                                <h3>Lorem ipsum</h3>
